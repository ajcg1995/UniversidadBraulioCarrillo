...
// run every 7s
		...
		vectImg[3] = { fuente: "resources/boletines/boletin5.jpg"};
        vectImg[4] = { fuente: "resources/boletines/boletin5.jpg"};
;

		
		/*
		vectImg[4] = { fuente: "resources/imagen/boletin1.jpg"};
		
		vectImg[5] = { fuente: "resources/imagen/boletin2.jpg"};
		vectImg[6] = { fuente: "resources/imagen/boletin1.jpg"};	*/
